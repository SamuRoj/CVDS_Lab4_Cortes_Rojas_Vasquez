...
public class GUI {
    ...
    public GUI(Language language, HangmanDictionary dictionary, HangmanPanel hangmanPanel, GameScore typeGame) {
    ...
    private void setup() {
        ...
        GameModel gameModel = new GameModel(dictionary, typeGame);
